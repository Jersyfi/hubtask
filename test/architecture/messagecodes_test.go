...
var messageCode = regexp.MustCompile(`"((?:route|request|access|idempotency|config|errors|dependency|capacity|containers|ordering|events)\.[a-z][a-z0-9_]*(?:\.[a-z][a-z0-9_]*)*)"`)
