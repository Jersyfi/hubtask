...
<div class="section legal" lang="de">
  ...
  <section>
    <h2>Hinweis</h2>
    <p>
      Hubtask ist ein quellverfügbares Softwareprojekt einer Privatperson. Es werden derzeit
      keine entgeltlichen Leistungen über diese Website angeboten; eine
