...
func groups() []group {
	return []group{
		...
		trashGroup(), searchGroup(), importGroup(), watchGroup(), syncGroup(), conformanceGroup(), jobGroup(), backupGroup(), restoreGroup(), retentionGroup(), holdGroup(), auditGroup(), dsrGroup(),
