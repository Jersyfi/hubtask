...
| [0039](./ADR-0039-overlay-positioning.md) | Overlays are positioned by CSS, with one fallback we own | accepted | Design system, clients, supply chain |
...
| [0062](./ADR-0062-navigation-and-the-working-surface.md) | The navigation, the status place, and how a screen is worked | proposed | Design system, client, product |
