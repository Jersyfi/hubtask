...
**232 use cases, 203 distinct action codes, 167 of them recorded on every call.** A use case that
...
| Action | Use case | Target | Severity | Recorded |
|---|---|---|---|---|
| `ai.classification_asked` | AiClassify | `ai_suggestion` | NOTICE | Every time |
| `ai.decomposition_asked` | SuggestDecomposition | `ai_suggestion` | NOTICE | Every time |
| `ai.duplicates_asked` | SuggestDuplicates | `ai_suggestion` | NOTICE | Every time |
| `ai.fields_asked` | AiSuggestFields | `ai_suggestion` | NOTICE | Every time |
...
| `automation.rules_checked` | CheckRules | `automation_rule` | INFO | Every time |
...
| `container.moved` | ReorderContainer | `container` | INFO | Every time |
...
| Action | Use case | Target | Severity | Recorded |
|---|---|---|---|---|
| `identity.provider_configured` | ConfigureIdentityProvider | `identity_provider` | NOTICE | Every time |
| `identity.provider_read` | ReadIdentityProvider | `identity_provider` | INFO | When refused |
| `identity.provider_removed` | RemoveIdentityProvider | `identity_provider` | NOTICE | Every time |
...
| Action | Use case | Target | Severity | Recorded |
|---|---|---|---|---|
| `oauth.client_deleted` | DeleteOauthClient | `oauth_client` | NOTICE | Every time |
| `oauth.client_read` | ListOauthClients | `oauth_client` | INFO | When refused |
| `oauth.client_read` | ReadOauthClient | `oauth_client` | INFO | When refused |
| `oauth.client_registered` | RegisterOauthClient | `oauth_client` | NOTICE | Every time |
| `oauth.code_exchanged` | ExchangeOauthCode | `oauth_grant` | NOTICE | Every time |
| `oauth.consented` | AuthorizeOauthClient | `oauth_grant` | NOTICE | Every time |
| `oauth.grant_read` | ListOauthGrants | `oauth_grant` | INFO | When refused |
| `oauth.grant_revoked` | RevokeOauthGrant | `oauth_grant` | NOTICE | Every time |
