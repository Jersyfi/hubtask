...
wordmark and the border scale in F1, platform adaptation with the mobile shell in F6. The list is
not fixed — F1-02, F1-03 and F1-04 closed contrast verification, iconography and voice and tone,
and F1-13 closed the layering scale and opened two more, which is what a gap list does while a
milestone runs.
