 ...
 *
 * 77 icons, 11039 bytes of node data.
 */
...
export const BASE_MIRRORED = ['arrow-left', 'arrow-right', 'chevron-left', 'chevron-right', 'external-link', 'log-out', 'panel-left'] as const satisfies readonly (keyof typeof BASE_ICONS)[];
