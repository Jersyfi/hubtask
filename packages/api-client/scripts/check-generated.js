...
for (const entry of fs.readdirSync(source)) {
  ...
  // The generated client (tools/sdkgen, P-03) is a runtime value by nature and generated by
  // construction: its first line says so, and `make generate`'s no-diff check keeps it that way.
